...
<section class="sessaoFormulario">
    <h3>Novo serviço de manutenção</h3>
    ...
    <form id="cadastroComputador" action="../computador/cadastrarComputador.php" method="POST" style="display: none;" class="">
        ...
        <label>Marca</label>
        <?php echo selecionaMarcas("");?>&nbsp;<i class="glyphicon glyphicon-plus-sign" title="adicionar nova" onclick="modal(1, 1);"></i><br/>
        <label>Memória</label>
        <?php echo selecionaMemoria("");?>&nbsp;<i class="glyphicon glyphicon-plus-sign" title="adicionar nova" onclick="modal(2, 1)"></i><br/>
        <label>Processador</label>
        <?php echo selecionaProcessador("");?>&nbsp;<i class="glyphicon glyphicon-plus-sign" title="adicionar novo" onclick="modal(3, 1);"></i><br/>
        <label>Armazenamento</label>
        <?php echo selecionaArmazenamento("");?>&nbsp;<i class="glyphicon glyphicon-plus-sign" title="adicionar novo" onclick="modal(4, 1);"></i><br/>
    ...
    <form id="cadastroServico" action="cadastrarManutencao.php" method="POST" class="col-lg-12">
        ...
        <br/>
        <label>Usuário do Computador</label><br/><input type="text" name="usuario"><br/>
        <label>Departamento</label><br/><?php echo selecionaDepartamento("");?><br/><br/>
        <label>Entrada</label><br/><input type="date" name="dataEntrada" required="required" onchange="limitaComeco(this.value);"><br/>
        <label>Saída</label><br/><input type="date" name="dataSaida" required="required"><br/>
